/**
 * Main entry point for the Foodking rider API.
...
/**
 * 
 * Register microservice  routes for internal communication
 */
await server.register(microServiceRoutes, { prefix: "/rider/microservice" })
