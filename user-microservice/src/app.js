/**
 * Main entry point for the foodking API.
...
//     nameSpace: 'foodking-api-ratelimit-', // default is 'fastify-rate-limit-'
...
/**
 * 
 * Register microservice routes for internal communication routes
 */
await server.register(microServiceRoutes, { prefix: "/user/microservice" })
